          ...
          <div yueUiGridCol [yueUiGridColMd]="{ span: 23 }">
            ...
            <div style="margin: 50px 0px;width: 300px;">
              <yue-ui-card>
                <yue-ui-card-actions>
                  <yue-ui-card-action>
                    <button yueUiButton>Action 1</button>
                  </yue-ui-card-action>
                  <yue-ui-card-action>
                    <button yueUiButton>Action 2</button>
                  </yue-ui-card-action>
                </yue-ui-card-actions>
                ...
                <yue-ui-card-footer>Footer</yue-ui-card-footer>
                <yue-ui-card-metadata yueUiCardMetadataTitle="Title" yueUiCardMetadataDescription="Description" [yueUiCardMetadataAvatar]="avatar">
                  <ng-template #avatar>
                    <yue-ui-image yueUiImageSrc="https://zos.alipayobjects.com/rmsportal/ODTLcjxAfvqbxHnVXCYX.png" yueUiImageAlt="Simple user image placeholder"></yue-ui-image>
                  </ng-template>
