...
@Component({
    ...
    <ng-container *ngIf="isReady">
      <div class="field-text-wrapper" [class.hovering]="hovering">
        <ng-container *ngIf="mask">
          <input type="number" [formControl]="control" [textMask]="mask" (mouseover)="hovering = true;" (mouseout)="hovering = false;">
        </ng-container>
        <ng-container *ngIf="!mask">
          <input type="number" [formControl]="control" [placeholder]="placeholder" (mouseover)="hovering = true;" (mouseout)="hovering = false;">
        </ng-container>
  ...
  `,
  styleUrls: ['./input-enumerable.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class InputEnumerableComponent extends InputField implements OnInit {
